...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 03-Jan-2023 às 17:57
...
INSERT INTO `usuarios` (`id`, `login`, `senha`, `email`, `nome`, `nome_social`, `data_de_nascimento`, `ativo`) VALUES
(57, 'admin', '1234', 'admin', 'admin', 'admin', '2022-12-28', 1);
COMMIT;
