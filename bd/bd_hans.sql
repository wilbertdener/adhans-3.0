...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 24-Jan-2023 às 11:57
...
(1, '/adhans/application/views/diagnostico/textos/histamina/img_endo.jpg', 'Fig 3', 'B1) Incompleta: Imediatamente após riscos lineares e contínuos, observa-se eritema tênue, tornando a mancha hansênica mais desenhada e evidente (setas); <br>\nB2) Após 30-60 segundos, observa-se eritema reflexo mais intenso e delimitando melhor a mancha hansênica (setas); <br>\nB3) Sinal do dermografismo – pápula (*) após 3-5 minutos dos riscos, mantendo ainda o eritema reflexo em torno da mancha hansênica; <br>\nB4) Completa: Resposta completa demonstrada pelo eritema linear (0,5 a 1cm laterais ao risco) sobre as manchas hipocrômicas cicatriciais semelhantes às áreas normais;<br><br>\nFontes: Prof. Dr. Marco Andrey Cipriani Frade.', 'histamina', 'Teste', 'endogena'),
(2, '/adhans/application/views/diagnostico/textos/histamina/img_exo_1.jpg', 'Fig 1', 'COMPLETA com eritema ao redor da pápula na pele normal à esquerda (Triangulo) e INCOMPLETA devido a ausência de eritema na mancha à direita;<br><br>\nFontes: Instituto Lauro Souza Lima. \n', 'histamina', 'Teste', 'exogena'),
(3, '/adhans/application/views/diagnostico/textos/histamina/img_exo_2.jpg', 'Fig 2', 'COMPLETA com eritema intenso na região do abdome nas áreas de lesões de nevos congênitos acrômicos (losangulo) e pele normal (triangulo), enquanto INCOMPLETA na região do braço (setas) com ausência de eritema sobre área hipocrômica hansênica.<br><br>\nFontes: Prof. Dr. Marco Andrey Cipriani Frade.', 'histamina', 'Teste', 'exogena'),
(4, '/adhans/application/views/hanseniase/tipos/indeterminada.jpg', 'Fig 1 – Manifestações de hanseníase indeterminada', 'Manchas brancas lisas, mal delimitadas, que não coçam, não ardem, não queimam, não doem, não desaparecem, “não pegam poeira” por não suar na respectiva área, e tem diminuição de sensibilidade. Não há comprometimento de troncos nervosos nem grau de incapacidade.<br><br>\r\nFonte: Instituto Lauro Souza Lima.', 'hanseniase', NULL, 'Indeterminada'),
(5, '/adhans/application/views/hanseniase/tipos/tuberculoide_1.jpg', 'Fig 2 – Manifestações de hanseníase tuberculóide', 'Criança com lesão anular bem delimitada\r\ne totalmente anestésica.<br><br>\r\nFonte: Instituto Lauro Souza Lima.', 'hanseniase', NULL, 'tuberculoide'),
(6, '/adhans/application/views/hanseniase/tipos/tuberculoide_2.jpg', 'Fig 3 – Manifestações de hanseníase tuberculóide', 'Adulto com necrose inflamatória (abscesso) de parte do nervo\r\nmediano, causando hipoestesia e atrofia de músculo da mão.', 'hanseniase', NULL, 'tuberculoide'),
(7, '/adhans/application/views/hanseniase/tipos/dimorfa_1.jpg', 'Fig 4 – Manifestações d e hanseníase dimorfa', 'Lesão avermelhada elevada, mal delimitada, com centro irregular e “esburacado”, anestésica (perda total da sensibilidade) ou hipoestésica (perda parcial da sensibilidade).\r\n<br><br>Fontes: Fotos a, b e c: Instituto Lauro Souza Lima. Foto d: Prof. Dr. Marco Andrey Cipriani Frade', 'hanseniase', NULL, 'dimorfa'),
(8, '/adhans/application/views/hanseniase/tipos/dimorfa_2.jpg', 'Fig 5 – Manifestações d e hanseníase dimorfa', 'Presença de espessamento do nervo fibular superficial na região anterolateral da perna, no terço inferior.\r\n<br><br>Fontes: Fotos a, b e c: Instituto Lauro Souza Lima. Foto d: Prof. Dr. Marco Andrey Cipriani Frade', 'hanseniase', NULL, 'dimorfa'),
(9, '/adhans/application/views/hanseniase/tipos/dimorfa_3.jpg', 'Fig 6 – Manifestações d e hanseníase dimorfa', 'Várias lesões elevadas bem delimitadas,avermelhadas nas bordas e com centro branco, com perda total da sensibilidade.\r\n<br><br>Fontes: Fotos a, b e c: Instituto Lauro Souza Lima. Foto d: Prof. Dr. Marco Andrey Cipriani Frade', 'hanseniase', NULL, 'dimorfa'),
(10, '/adhans/application/views/hanseniase/tipos/dimorfa_4.jpg', 'Fig 7 – Manifestações d e hanseníase dimorfa', 'Múltiplas manchas hipocrômicas, com bordas imprecisas, sensibilidade e sudorese diminuídas e/ou ausentes.\r\n<br><br>Fontes: Fotos a, b e c: Instituto Lauro Souza Lima. Foto d: Prof. Dr. Marco Andrey Cipriani Frade', 'hanseniase', NULL, 'dimorfa'),
(11, '/adhans/application/views/hanseniase/tipos/virchowiana_1.jpg', 'Fig 8 – Tipos de manifestação de hanseníase virchowiana', 'Face infiltrada, presença de múltiplos hansenomas\r\n(pápulas), assimetria de sobrancelhas (lesão parcial\r\ndo nervo facial esquerdo) e rarefação dos pelos das\r\nlaterais das sobrancelhas (madarose parcial).\r\n<br>Fontes: Foto a: Prof. Dr. Marco Andrey Cipriani Frade. Fotos b, c e d: Instituto Lauro Souza Lima.', 'hanseniase', NULL, 'virchowiana'),
(12, '/adhans/application/views/hanseniase/tipos/virchowiana_2.jpg', 'Fig 9 – Tipos de manifestação de hanseníase virchowiana', 'Falta de sobrancelhas e cílios, osso do nariz alargado e\r\nachatado, obstrução nasal.\r\n<br>Fontes: Foto a: Prof. Dr. Marco Andrey Cipriani Frade. Fotos b, c e d: Instituto Lauro Souza Lima.', 'hanseniase', NULL, 'virchowiana'),
(13, '/adhans/application/views/hanseniase/tipos/virchowiana_3.jpg', 'Fig 10 – Tipos de manifestação de hanseníase virchowiana', 'Pele lisa, sem pelos, seca, quase totalmente avermelhada e inchada (menos no meio da coluna lombar),\r\ncom vasinhos visíveis; não há manchas.\r\n<br>Fontes: Foto a: Prof. Dr. Marco Andrey Cipriani Frade. Fotos b, c e d: Instituto Lauro Souza Lima.', 'hanseniase', NULL, 'virchowiana'),
(14, '/adhans/application/views/hanseniase/tipos/virchowiana_4.jpg', 'Fig 11 – Tipos de manifestação de hanseníase virchowiana', 'Caroços duros nas coxas, que não doem e não coçam,\r\nalguns ulcerados, de vários meses de duração; note\r\nque ainda há pelos.\r\n<br>Fontes: Foto a: Prof. Dr. Marco Andrey Cipriani Frade. Fotos b, c e d: Instituto Lauro Souza Lima.', 'hanseniase', NULL, 'virchowiana'),
(15, '/adhans/application/views/hanseniase/historia/transmissao_1.jpg', 'Fig 1 - Fotos de uma criança com hanseníase.', 'Criança na fase inicial da doença, e sua evolução lenta e progressiva ao longo dos anos.\r\nFonte: Banco de imagens do Instituto Lauro de Souza Lima, Bauru, SP.', 'historia', 'transmissao', NULL),
(16, '/adhans/application/views/hanseniase/historia/tratamento_1.jpg', 'Fig 2 – Cartelas de Poliquimioterapia', 'À direita, esquema para pacientes adultos multibacilares (MB) e à esquerda esquema para pacientes paucibacilares (PB).\r\n<br>Fonte: Coordenação-Geral de Hanseníase e Doenças em Eliminação – CGHDE/DEVIT/SVS/MS.', 'historia', 'tratamento', NULL),
(17, '/adhans/application/views/diagnostico/sudoral/sudoral_1.jpg', 'Fig 1 - Área extensa de anidrose (setas) circunscrita por áreas de normoidrose.', 'Fonte: Prof. Dr. Marco Andrey Cipriani Frade.', 'sudoral', NULL, NULL),
(18, '/adhans/application/views/diagnostico/sudoral/sudoral_2.jpg', 'Fig 2 - Área de anidrose (seta) coincidente à área de hipocromia e sudorese profusa periférica. ', 'Fonte: Prof. Dr. Marco Andrey Cipriani Frade.', 'sudoral', NULL, NULL),
(19, '/adhans/application/views/diagnostico/dolorosa/dolorosa_1.jpg', 'Fig 1 ', 'Encoste a ponta da agulha (Foto a) e o plástico (Foto b), e pergunte ao paciente se ele sente a diferença.<br>\r\nFonte: Banco de imagens do Instituto Lauro de Souza Lima', 'dolorosa', 'introducao', NULL);
...
(1, 'Pedro Santos', '2022-12-01', '31708332863', 57, NULL),
(2, 'Raquel Carvalho', '2022-12-14', '41965007147', 57, NULL),
(3, 'Sabrina Nogueira', '2023-01-03', 'FG84918217168', 57, '0000-00-00'),
(4, 'Enrico Oliveira', '2023-01-03', '19649428534', 57, '2023-01-19'),
(5, 'Brenda Oliveira', '2023-01-03', '68481896268', 57, '0000-00-00'),
(6, 'Brenda Oliveira', '2023-01-03', '31568112386', 57, '2023-01-31'),
(7, 'Luiz Miguel Souza', '2023-01-03', '67293868863', 57, '0000-00-00'),
(8, 'Guilherme Silva', NULL, '47528963119', 58, '0000-00-00'),
(9, 'Dra. Stephany Cardoso', NULL, '48092408602', 58, '0000-00-00');
...
(57, 'admin', 'admin', 'admin', 'admin', 'admin', '2022-12-28', 1, 'admin'),
